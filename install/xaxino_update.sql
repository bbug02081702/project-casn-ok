...
-- Thời gian đã tạo: Th10 06, 2022 lúc 05:00 AM
...
(1, 'Super Admin', 'admin@site.com', 'admin', NULL, '634fe61d433921666180637.jpg', '$2y$10$xAWUuO1.D5cPJR4XZRgS1OuGPnU0DZbpmDnGoQSU2vlZcCt.iZmgy', NULL, NULL, '2022-11-05 21:47:57');
...
(1, 1, 'New member registered', 1, '/admin/users/detail/1', '2022-11-05 21:36:42', '2022-11-05 21:46:08');
...
(18, 'manual_deposit', '[]', '2022-11-05 21:58:03', '2022-11-05 21:58:03');
...
--
-- Cấu trúc bảng cho bảng `game_logs`
--
...
CREATE TABLE `game_logs` (
  ...
  `user_select` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `game_logs`
--

INSERT INTO `game_logs` (`id`, `user_id`, `game_id`, `user_select`, `result`, `status`, `invest`, `win_amo`, `try`, `win_status`, `game_name`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'head', 'head', 1, '1.00000000', '0.50000000', 0, 1, NULL, '2022-11-05 21:51:53', '2022-11-05 21:52:10'),
(2, 1, 1, 'head', 'head', 1, '10.50000000', '5.25000000', 0, 1, NULL, '2022-11-05 21:52:32', '2022-11-05 21:52:48'),
(3, 1, 1, 'tail', 'tail', 1, '15.75000000', '7.87500000', 0, 1, NULL, '2022-11-05 21:53:06', '2022-11-05 21:53:22'),
(4, 1, 1, 'head', 'head', 1, '23.00000000', '11.50000000', 0, 1, NULL, '2022-11-05 21:54:00', '2022-11-05 21:54:15'),
(5, 1, 1, 'head', 'head', 1, '35.00000000', '17.50000000', 0, 1, NULL, '2022-11-05 21:54:35', '2022-11-05 21:54:50');
...
(49, 0, 121, 'NMI', 'NMI', 1, '{\"api_key\":{\"title\":\"API Key\",\"global\":true,\"value\":\"-------\"}}', '{\"AED\":\"AED\",\"ARS\":\"ARS\",\"AUD\":\"AUD\",\"BOB\":\"BOB\",\"BRL\":\"BRL\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"CLP\":\"CLP\",\"CNY\":\"CNY\",\"COP\":\"COP\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"HKD\":\"HKD\",\"IDR\":\"IDR\",\"ILS\":\"ILS\",\"INR\":\"INR\",\"JPY\":\"JPY\",\"KRW\":\"KRW\",\"MXN\":\"MXN\",\"MYR\":\"MYR\",\"NOK\":\"NOK\",\"NZD\":\"NZD\",\"PEN\":\"PEN\",\"PHP\":\"PHP\",\"PLN\":\"PLN\",\"PYG\":\"PYG\",\"RUB\":\"RUB\",\"SEC\":\"SEC\",\"SGD\":\"SGD\",\"THB\":\"THB\",\"TRY\":\"TRY\",\"TWD\":\"TWD\",\"USD\":\"USD\",\"ZAR\":\"ZAR\"}', 0, NULL, NULL, NULL, '2022-08-28 10:12:37'),
(50, 18, 1000, 'test widr', 'test_widr', 1, '[]', '[]', 0, NULL, '<br>', '2022-11-05 21:58:03', '2022-11-05 21:58:03');
...
--
-- Đang đổ dữ liệu cho bảng `gateway_currencies`
--
...
(1, 'test widr', '45', '', 1000, 'test_widr', '1.00000000', '3.00000000', '2.00', '1.00000000', '2.00000000', NULL, '2022-11-05 21:58:03', '2022-11-05 21:58:03');
...
(1, 1, 'php', 'info@viserlab.com', 'yuntips1702@gmail.com', 'User Register Bonus', '<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\r\n  <!--[if !mso]><!-->\r\n  <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\r\n  <!--<![endif]-->\r\n  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n  <title></title>\r\n  <style type=\"text/css\">\r\n.ReadMsgBody { width: 100%; background-color: #ffffff; }\r\n.ExternalClass { width: 100%; background-color: #ffffff; }\r\n.ExternalClass, .ExternalClass p, .ExternalClass span, .ExternalClass font, .ExternalClass td, .ExternalClass div { line-height: 100%; }\r\nhtml { width: 100%; }\r\nbody { -webkit-text-size-adjust: none; -ms-text-size-adjust: none; margin: 0; padding: 0; }\r\ntable { border-spacing: 0; table-layout: fixed; margin: 0 auto;border-collapse: collapse; }\r\ntable table table { table-layout: auto; }\r\n.yshortcuts a { border-bottom: none !important; }\r\nimg:hover { opacity: 0.9 !important; }\r\na { color: #0087ff; text-decoration: none; }\r\n.textbutton a { font-family: \'open sans\', arial, sans-serif !important;}\r\n.btn-link a { color:#FFFFFF !important;}\r\n\r\n@media only screen and (max-width: 480px) {\r\nbody { width: auto !important; }\r\n*[class=\"table-inner\"] { width: 90% !important; text-align: center !important; }\r\n*[class=\"table-full\"] { width: 100% !important; text-align: center !important; }\r\n/* image */\r\nimg[class=\"img1\"] { width: 100% !important; height: auto !important; }\r\n}\r\n</style>\r\n\r\n\r\n\r\n  <table bgcolor=\"#414a51\" width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n    <tbody><tr>\r\n      <td height=\"50\"></td>\r\n    </tr>\r\n    <tr>\r\n      <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n          <tbody><tr>\r\n            <td align=\"center\" width=\"600\">\r\n              <!--header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#0087ff\" style=\"border-top-left-radius:6px; border-top-right-radius:6px;text-align:center;vertical-align:top;font-size:0;\" align=\"center\">\r\n                    <table width=\"90%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#FFFFFF; font-size:16px; font-weight: bold;\">This is a System Generated Email</td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n              <!--end header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#FFFFFF\" align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"35\"></td>\r\n                      </tr>\r\n                      <!--logo-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"vertical-align:top;font-size:0;\">\r\n                          <a href=\"#\">\r\n                            <img style=\"display:block; line-height:0px; font-size:0px; border:0px;\" src=\"https://i.imgur.com/Z1qtvtV.png\" alt=\"img\">\r\n                          </a>\r\n                        </td>\r\n                      </tr>\r\n                      <!--end logo-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n                      <!--headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open Sans\', Arial, sans-serif; font-size: 22px;color:#414a51;font-weight: bold;\">Hello tai nguyen (testadmin)</td>\r\n                      </tr>\r\n                      <!--end headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                          <table width=\"40\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                            <tbody><tr>\r\n                              <td height=\"20\" style=\" border-bottom:3px solid #0087ff;\"></td>\r\n                            </tr>\r\n                          </tbody></table>\r\n                        </td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <!--content-->\r\n                      <tr>\r\n                        <td align=\"left\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#7f8c8d; font-size:16px; line-height: 28px;\"><div>Hi, testadmin</div><div></div><div>You have got 10.00 USD for register bonus.&nbsp;<br></div><div>Your current Balance: 10.00 USD,</div><div>Transaction Number : JFHDYGHA9UUR,</div></td>\r\n                      </tr>\r\n                      <!--end content-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n              \r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n                <tr>\r\n                  <td height=\"45\" align=\"center\" bgcolor=\"#f4f4f4\" style=\"border-bottom-left-radius:6px;border-bottom-right-radius:6px;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                      <!--preference-->\r\n                      <tr>\r\n                        <td class=\"preference-link\" align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#95a5a6; font-size:14px;\">\r\n                          © 2021 <a href=\"#\">Xaxino</a>&nbsp;. All Rights Reserved. \r\n                        </td>\r\n                      </tr>\r\n                      <!--end preference-->\r\n                      <tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n            </td>\r\n          </tr>\r\n        </tbody></table>\r\n      </td>\r\n    </tr>\r\n    <tr>\r\n      <td height=\"60\"></td>\r\n    </tr>\r\n  </tbody></table>', 'email', '2022-11-05 21:37:26', '2022-11-05 21:37:26'),
(2, 1, 'php', 'info@viserlab.com', 'yuntips1702@gmail.com', 'test notification', '<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\r\n  <!--[if !mso]><!-->\r\n  <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\r\n  <!--<![endif]-->\r\n  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n  <title></title>\r\n  <style type=\"text/css\">\r\n.ReadMsgBody { width: 100%; background-color: #ffffff; }\r\n.ExternalClass { width: 100%; background-color: #ffffff; }\r\n.ExternalClass, .ExternalClass p, .ExternalClass span, .ExternalClass font, .ExternalClass td, .ExternalClass div { line-height: 100%; }\r\nhtml { width: 100%; }\r\nbody { -webkit-text-size-adjust: none; -ms-text-size-adjust: none; margin: 0; padding: 0; }\r\ntable { border-spacing: 0; table-layout: fixed; margin: 0 auto;border-collapse: collapse; }\r\ntable table table { table-layout: auto; }\r\n.yshortcuts a { border-bottom: none !important; }\r\nimg:hover { opacity: 0.9 !important; }\r\na { color: #0087ff; text-decoration: none; }\r\n.textbutton a { font-family: \'open sans\', arial, sans-serif !important;}\r\n.btn-link a { color:#FFFFFF !important;}\r\n\r\n@media only screen and (max-width: 480px) {\r\nbody { width: auto !important; }\r\n*[class=\"table-inner\"] { width: 90% !important; text-align: center !important; }\r\n*[class=\"table-full\"] { width: 100% !important; text-align: center !important; }\r\n/* image */\r\nimg[class=\"img1\"] { width: 100% !important; height: auto !important; }\r\n}\r\n</style>\r\n\r\n\r\n\r\n  <table bgcolor=\"#414a51\" width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n    <tbody><tr>\r\n      <td height=\"50\"></td>\r\n    </tr>\r\n    <tr>\r\n      <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n          <tbody><tr>\r\n            <td align=\"center\" width=\"600\">\r\n              <!--header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#0087ff\" style=\"border-top-left-radius:6px; border-top-right-radius:6px;text-align:center;vertical-align:top;font-size:0;\" align=\"center\">\r\n                    <table width=\"90%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#FFFFFF; font-size:16px; font-weight: bold;\">This is a System Generated Email</td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n              <!--end header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#FFFFFF\" align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"35\"></td>\r\n                      </tr>\r\n                      <!--logo-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"vertical-align:top;font-size:0;\">\r\n                          <a href=\"#\">\r\n                            <img style=\"display:block; line-height:0px; font-size:0px; border:0px;\" src=\"https://i.imgur.com/Z1qtvtV.png\" alt=\"img\">\r\n                          </a>\r\n                        </td>\r\n                      </tr>\r\n                      <!--end logo-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n                      <!--headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open Sans\', Arial, sans-serif; font-size: 22px;color:#414a51;font-weight: bold;\">Hello tai nguyen (testadmin)</td>\r\n                      </tr>\r\n                      <!--end headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                          <table width=\"40\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                            <tbody><tr>\r\n                              <td height=\"20\" style=\" border-bottom:3px solid #0087ff;\"></td>\r\n                            </tr>\r\n                          </tbody></table>\r\n                        </td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <!--content-->\r\n                      <tr>\r\n                        <td align=\"left\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#7f8c8d; font-size:16px; line-height: 28px;\">this test notifications</td>\r\n                      </tr>\r\n                      <!--end content-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n              \r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n                <tr>\r\n                  <td height=\"45\" align=\"center\" bgcolor=\"#f4f4f4\" style=\"border-bottom-left-radius:6px;border-bottom-right-radius:6px;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                      <!--preference-->\r\n                      <tr>\r\n                        <td class=\"preference-link\" align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#95a5a6; font-size:14px;\">\r\n                          © 2021 <a href=\"#\">Xaxino</a>&nbsp;. All Rights Reserved. \r\n                        </td>\r\n                      </tr>\r\n                      <!--end preference-->\r\n                      <tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n            </td>\r\n          </tr>\r\n        </tbody></table>\r\n      </td>\r\n    </tr>\r\n    <tr>\r\n      <td height=\"60\"></td>\r\n    </tr>\r\n  </tbody></table>', 'email', '2022-11-05 21:44:28', '2022-11-05 21:44:28');
...
(1, 1, '10.00000000', '0.00000000', '10.00000000', '+', 'JFHDYGHA9UUR', 'You have got register bonus', 'register_bonus', '2022-11-05 21:37:23', '2022-11-05 21:37:23'),
(2, 1, '1.00000000', '0.00000000', '9.00000000', '-', 'JRQMRQDFTM5M', 'Invest to Head & Tail', 'invest', '2022-11-05 21:51:53', '2022-11-05 21:51:53'),
(3, 1, '1.00000000', '0.00000000', '10.00000000', '+', 'GX99HDBZ55SR', 'Invest Back For Head & Tail', 'invest_back', '2022-11-05 21:52:09', '2022-11-05 21:52:09'),
(4, 1, '0.50000000', '0.00000000', '10.50000000', '+', 'GX99HDBZ55SR', 'Win bonus of Head & Tail', 'Win_Bonus', '2022-11-05 21:52:09', '2022-11-05 21:52:09'),
(5, 1, '10.50000000', '0.00000000', '0.00000000', '-', 'O2K19H1ZEU7B', 'Invest to Head & Tail', 'invest', '2022-11-05 21:52:32', '2022-11-05 21:52:32'),
(6, 1, '10.50000000', '0.00000000', '10.50000000', '+', '1VMBM66KRR3F', 'Invest Back For Head & Tail', 'invest_back', '2022-11-05 21:52:48', '2022-11-05 21:52:48'),
(7, 1, '5.25000000', '0.00000000', '15.75000000', '+', '1VMBM66KRR3F', 'Win bonus of Head & Tail', 'Win_Bonus', '2022-11-05 21:52:48', '2022-11-05 21:52:48'),
(8, 1, '15.75000000', '0.00000000', '0.00000000', '-', '6XX1C36CTCCR', 'Invest to Head & Tail', 'invest', '2022-11-05 21:53:06', '2022-11-05 21:53:06'),
(9, 1, '15.75000000', '0.00000000', '15.75000000', '+', '3RRWOHFS3R44', 'Invest Back For Head & Tail', 'invest_back', '2022-11-05 21:53:22', '2022-11-05 21:53:22'),
(10, 1, '7.87500000', '0.00000000', '23.62500000', '+', '3RRWOHFS3R44', 'Win bonus of Head & Tail', 'Win_Bonus', '2022-11-05 21:53:22', '2022-11-05 21:53:22'),
(11, 1, '23.00000000', '0.00000000', '0.62500000', '-', 'A4HKPEFQDGFP', 'Invest to Head & Tail', 'invest', '2022-11-05 21:54:00', '2022-11-05 21:54:00'),
(12, 1, '23.00000000', '0.00000000', '23.62500000', '+', 'NNFBCRB9MFYH', 'Invest Back For Head & Tail', 'invest_back', '2022-11-05 21:54:15', '2022-11-05 21:54:15'),
(13, 1, '11.50000000', '0.00000000', '35.12500000', '+', 'NNFBCRB9MFYH', 'Win bonus of Head & Tail', 'Win_Bonus', '2022-11-05 21:54:15', '2022-11-05 21:54:15'),
(14, 1, '35.00000000', '0.00000000', '0.12500000', '-', 'X49BHG9CJXVE', 'Invest to Head & Tail', 'invest', '2022-11-05 21:54:35', '2022-11-05 21:54:35'),
(15, 1, '35.00000000', '0.00000000', '35.12500000', '+', 'RAMYNR5C1GX5', 'Invest Back For Head & Tail', 'invest_back', '2022-11-05 21:54:50', '2022-11-05 21:54:50'),
(16, 1, '17.50000000', '0.00000000', '52.62500000', '+', 'RAMYNR5C1GX5', 'Win bonus of Head & Tail', 'Win_Bonus', '2022-11-05 21:54:50', '2022-11-05 21:54:50');
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `username`, `email`, `country_code`, `mobile`, `ref_by`, `balance`, `password`, `image`, `address`, `status`, `ev`, `sv`, `ver_code`, `ver_code_send_at`, `ts`, `tv`, `tsc`, `remember_token`, `kyc_data`, `kv`, `profile_complete`, `ban_reason`, `created_at`, `updated_at`) VALUES
(1, 'tai', 'nguyen', 'testadmin', 'yuntips1702@gmail.com', 'VN', '84364289473', 0, '52.62500000', '$2y$10$m7THHTufmdph53aSDf0B8.1UZdRZMneSzWmOOgOEr46ex6ynGhP.e', NULL, '{\"country\":\"Vietnam\",\"address\":\"nghe an\",\"state\":\"do luong\",\"zip\":\"46000\",\"city\":\"vinh\"}', 1, 1, 1, NULL, NULL, 0, 1, NULL, NULL, NULL, 1, 1, NULL, '2022-11-05 21:36:42', '2022-11-05 21:54:50');
...
(1, 1, '127.0.0.1', '', '', '', '', '', 'Chrome', 'Windows 10', '2022-11-05 21:36:43', '2022-11-05 21:36:43');
...
--
-- Chỉ mục cho bảng `guess_bonuses`
--
...
--
-- AUTO_INCREMENT cho bảng `game_logs`
--
ALTER TABLE `game_logs`
...
--
-- AUTO_INCREMENT cho bảng `guess_bonuses`
--
ALTER TABLE `guess_bonuses`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
